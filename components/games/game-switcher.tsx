...
import { createGameHref } from "@/lib/game-scope";
    ...
    <div className="rounded-3xl border bg-white p-4 shadow-sm">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <p className="text-sm font-medium">Aktives TCG</p>
            <p className="text-xs text-slate-500">
              Alle Daten auf dieser Seite sind nach TCG gefiltert.
            </p>
          </div>
        </div>
        ...
        {games.map((game) => {
          ...
          return (
            <Button
              ...
              asChild
            >
              <Link href={createGameHref(pathname, game.slug)}>
